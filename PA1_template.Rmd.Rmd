...
##Step 1
##Code for readingin the dataset and processing the data
```{r, echo = TRUE}
setwd("C:/Users/s445464/OneDrive - University of Canberra/PhD/R script/Reproducible Research")
...
ggplot(Q2,aes(y=Q2$`Total Steps`,x=Dates))+geom_bar(stat="identity") + ylab("Total Steps")+xlab("Date")+ggtitle("Total Steps by date")
dev.off()
ggplot(Q2,aes(y=Q2$`Total Steps`,x=Dates))+geom_bar(stat="identity") + ylab("Total Steps")+xlab("Date")+ggtitle("Total Steps by date")
